...
-- Structural equality comparator used as one product term in the decoder.
entity opcode_match8 is
    generic (
        expected_opcode : std_logic_vector(7 downto 0)
    );
    port (
...
architecture structural of opcode_match8 is
